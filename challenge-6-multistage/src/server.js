...
app.get('/', (req, res) => {
    res.send(`<!DOCTYPE html><html><head>${css}</head><body><div class="card success">🎉 Bravo !<br>Défi 6 complété : Le Multi-stage build fonctionne et l'image finale de production est optimisée et allégée !</div></body></html>`);
});
