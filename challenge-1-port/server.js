...
app.get('/', (req, res) => {
    res.send(`<!DOCTYPE html><html><head>${css}</head><body><div class="card success">🎉 أحسنت! تم حل التمرين بنجاح.<br>تحدي 1 مكتمل: مبروك، لقد قمت بربط منفذ الحاوية بجهازك بنجاح!</div></body></html>`);
});
